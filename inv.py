...
# ------- OCULTAR MENÚ Y FOOTER SIN AFECTAR EL HEADER NI EL SIDEBAR ---------
hide_streamlit_style = """
    <style>
    #MainMenu {visibility: hidden;}
    footer {visibility: hidden;}
    /* Ocultar únicamente los elementos interactivos de la derecha del header sin romper el botón del sidebar */
