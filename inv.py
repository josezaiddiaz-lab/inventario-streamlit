...
# ------- CONFIGURACIÓN DE PÁGINA (FORZAR SIDEBAR EXPANDIDO) ---------
st.set_page_config(
    page_title="Control de Inventario GCM", 
    layout="centered",
    initial_sidebar_state="expanded"  # Asegura que el sidebar esté abierto por defecto
) 

# ------- OCULTAR TOOLBAR Y FOOTER (DEJANDO EL BOTÓN DEL SIDEBAR VISIBLE) ---------
hide_streamlit_style = """
    <style>
    /* Oculta la barra de herramientas superior (Share, Edit, Star, GitHub) */
    [data-testid="stToolbar"] {
        display: none !important;
    }
    /* Oculta el menú desplegable de tres puntos de la esquina superior derecha */
    #MainMenu {
        visibility: hidden;
    }
    /* Oculta el pie de página ("Alojado con Streamlit") */
    footer {
        visibility: hidden;
    }
    /* Mantiene transparente el fondo del encabezado sin ocultar el botón del sidebar */
    header {
...
# --------EXPORTAR REPORTE GENERAL A PDF (FILAS UNIFORMES Y FUENTE DINÁMICA)-------- 
def exportar_pdf(): 
    df_productos = cargar_inventario_dataframe()
    ...
    # Anchos definidos (Suma = 190 mm, margen exacto para A4)
    ...
    for _, row in df_productos.iterrows(): 
        ...
        # Ajustar tamaño de fuente dinámicamente si el texto es muy largo
...
# --------EXPORTAR REPORTE DE PEDIDOS A PDF (FILAS UNIFORMES Y FUENTE DINÁMICA)-------- 
