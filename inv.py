...
# Código CSS para ocultar la barra roja inferior y el icono de estado azul
hide_streamlit_elements = """
            <style>
            /* Ocultar la barra inferior de 'Alojado con Streamlit' */
            footer {visibility: hidden;}
            [data-testid="stDecoration"] {display: none;}
            
            /* Ocultar el botón azul de estado/perfil */
