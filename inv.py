...
if menu == "Registrar Producto": 
    ...
    almacen = st.selectbox("Almacén", [1, 2, 3, 4])  # 👈 NUEVO
...
# --------VER INVENTARIO (EDITABLE)--------
elif menu == "Ver Inventario": 
    st.subheader("Reporte General de Inventario") 
    st.caption("💡 Puedes corregir el nombre de un producto directamente en la tabla.")
    ...
    if not inventario: 
        ...
        tabla = st.data_editor(
            ...
            column_config={
                ...
                "ALMACÉN": st.column_config.NumberColumn(disabled=True),
        ...
        if tabla != lista:
            ...
            if not error:
                ...
                st.success("✅ Nombre corregido correctamente")
                st.rerun()
