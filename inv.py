...
# -------OCULTAR TOOLBAR / BOTONES DE ACCIÓN (SHARE, EDIT, STAR, GITHUB) Y FOOTER---------
hide_streamlit_style = """
    ...
    header {visibility: hidden;}    /* Oculta el encabezado/barra superior */
    footer {visibility: hidden;}    /* Oculta "Alojado con Streamlit" / pie de página */
    </style>
"""
