...
# -------- BARRA LATERAL (Menú de opciones, usuario, actualizar y salir) ----------
with st.sidebar:
    st.write(f"👤 **{st.session_state['usuario']}**")
    st.markdown("---")
    
    # Menú de opciones recuperado en la barra lateral
    menu = st.selectbox(
        "Opciones", 
...
# -------- CABECERA SUPERIOR (Título grande centrado a lo largo y logo a la derecha) ---------- 
col_logo_izq, col_title, col_logo_der = st.columns([1, 6, 1])
