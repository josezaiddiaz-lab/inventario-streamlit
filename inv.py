...
# ------- OCULTAR ÚNICAMENTE ACCIONES DEL ENCABEZADO Y MENÚ DE 3 PUNTOS ---------
st.markdown("""
    <style>
    /* Oculta únicamente los íconos de la derecha: Share, Star, Edit, GitHub */
    [data-testid="stHeaderActionElements"] {
        display: none !important;
        visibility: hidden !important;
    }
    
    /* Oculta el menú desplegable de los tres puntos */
    #MainMenu {
        display: none !important;
        visibility: hidden !important;
    }
    
    /* Mantiene transparente el header y visible el botón para abrir/cerrar sidebar */
