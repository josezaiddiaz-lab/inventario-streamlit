...
# ------- OCULTAR TOOLBAR (SHARE, GITHUB, EDITAR, MENÚ 3 PUNTOS) ---------
st.markdown("""
    <style>
    /* Ocultar barra de herramientas (Share, Star, Edit, GitHub) */
    ...
    /* Ocultar menú desplegable de tres puntos */
    #MainMenu {
        display: none !important;
        visibility: hidden !important;
    }
    /* Mantener visible el botón para abrir/cerrar sidebar */
