    ...
    if df_productos.empty: 
        ...
        class PDFReporte(FPDF):
            ...
            def add_row_multi_cell(self, row_data):
                # Calcular altura requerida para la celda del producto (columna más larga)
                self.set_font("Arial", '', 9)
                prod_text = limpiar_texto_pdf(row_data[0])
                
                # Usamos un truco con string splitting o calculamos líneas según el ancho disponible (65mm)
                # FPDF permite calcular con get_string_width o multi_cell en modo simulación, 
                # o una aproximación segura basada en el ancho de la celda.
                line_height = 5
                
                # Como FPDF maneja multi_cell, calculamos cuántas líneas ocupa el texto largo:
                # Una forma limpia en FPDF estándar para celdas de altura dinámica con bordes uniformes:
                # Obtenemos la altura que tomará multi_cell imprimiendo en una celda temporal o calculando líneas.
                
                # Una alternativa robusta y limpia en FPDF sin solapamientos:
                # Dividir el texto en líneas que quepan en w_prod (65)
                ...
                for word in words:
                    ...
                    if self.get_string_width(test_line) <= (w_prod - 4): # 4mm de margen interno
                ...
                # Verificar si hay espacio suficiente en la página antes de dibujar la fila
                ...
                # Dibujar celdas de altura uniforme para toda la fila
                ...
                # Imprimir el texto multilínea del producto alineado a la izquierda verticalmente centrado
                ...
                # Imprimir las demás columnas centradas en altura y texto
