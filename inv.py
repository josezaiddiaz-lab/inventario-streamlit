    ...
    if df_productos.empty:
        ...
        if prod_seleccionado:
            ...
            with col_img:
                ...
                # Carga de archivo o foto directa para Imagen 1
                ...
                if archivo_foto_1 is not None:
                    bytes_data = archivo_foto_1.getvalue()
                    base64_img = base64.b64encode(bytes_data).decode("utf-8")
                    nueva_url_1 = f"data:image/jpeg;base64,{base64_img}"

                # Carga de archivo o foto directa para Imagen 2
                ...
                if archivo_foto_2 is not None:
                    bytes_data = archivo_foto_2.getvalue()
                    base64_img = base64.b64encode(bytes_data).decode("utf-8")
                    nueva_url_2 = f"data:image/jpeg;base64,{base64_img}"
