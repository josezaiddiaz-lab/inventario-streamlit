...
# 🛠️ FUNCIÓN AUXILIAR PARA OBTENER LA FECHA REAL CORRECTA (Evita desfase UTC)
def obtener_fecha_hoy():
    # Si notas que el servidor sigue adelantado, puedes ajustar las horas restando tu diferencia o usando .date() local
    # Usamos date.today() para asegurar la fecha local del entorno o la del servidor ajustada si fuera necesario.
    ...
    if df_productos.empty: 
        ...
        if st.button("Registrar Movimiento"): 
            if not nombre:
                ...
                # CORRECCIÓN: Usar la fecha actual corregida sin desfase de zona horaria
