...
# ------- OCULTAR MENÚ DE TRES PUNTOS Y FOOTER SIN AFECTAR EL SIDEBAR ---------
st.markdown("""
    <style>
    /* Ocultar únicamente el menú de Streamlit (los tres puntos de la esquina) */
    #MainMenu {visibility: hidden !important;}
    
    /* Ocultar el pie de página */
    footer {visibility: hidden !important;}
    
    /* Ocultar solo el botón de Deploy y elementos de la derecha, manteniendo visible el botón del sidebar */
    .stAppDeployButton {
