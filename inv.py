...
# CORRECCIÓN: Se agregó la opción "Solicitar Pedidos" al menú lateral
...
# ----------NUEVA OPCIÓN: SOLICITAR PEDIDOS-------- 
if menu == "Solicitar Pedidos": 
    st.subheader("Productos por Agotarse (Stock en 0 o 1)") 
    inventario = cargar_inventario() 
    
    # Filtramos únicamente los productos con cantidad de 0 o 1
    productos_bajos = [] 
    for nombre, datos in inventario.items(): 
    ...
    if not productos_bajos: 
        ...
        # Se muestra la tabla estática limpia con solo las dos columnas solicitadas
