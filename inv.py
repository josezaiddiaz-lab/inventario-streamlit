    ...
    if df_productos.empty: 
        ...
        tabla = st.data_editor(
            ...
            column_config={
                ...
                "ALMACÉN": st.column_config.NumberColumn(alignment="center",min_value=1.0, max_value=99.0, step=0.1 format="%d"),
        ...
        class PDFReporte(FPDF):
            ...
            def add_row_multi_cell(self, row_data):
                ...
                # Dividir por espacios primero, y si una sola palabra es más ancha que la celda, forzar corte
