...
# ------- OCULTAR HEADER COMPLETO PERO MANTENER BOTÓN DE SIDEBAR ---------
st.markdown("""
    <style>
    /* Oculta toda la barra superior (Share, estrellas, lápiz, GitHub, tres puntos) */
    [data-testid="stHeader"] {
        display: none !important;
        visibility: hidden !important;
    }
    
    /* Fuerza a que el botón para abrir/cerrar el sidebar siga visible y flotando */
