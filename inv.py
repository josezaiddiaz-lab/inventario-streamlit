...
# ------- OCULTAR ÚNICAMENTE SHARE, FAVORITO, EDITAR Y GITHUB ---------
st.markdown("""
    <style>
    /* Oculta SOLO los botones de la izquierda (Share, Star, Edit, GitHub) */
    [data-testid="stHeaderActionElements"] {
        display: none !important;
        visibility: hidden !important;
    }

    /* Asegura que la barra lateral y su botón sigan intactos */
