...
def exportar_pdf(): 
    ...
    # Retorna los bytes puros de forma compatible con cualquier versión de FPDF
...
if menu == "Registrar Producto": 
    ...
    if st.button("Registrar Producto"): 
        if nombre: 
            registrar_producto(nombre, quantity=cantidad, fecha=fecha) 
        else: 
...
if menu == "Registrar Movimiento": 
    ...
    if not productos: 
        ...
        if st.button("Registrar Movimiento"): 
            registrar_movimiento(nombre, tipo, cantidad)  # <-- Corregido: 'quantity' cambiado a 'cantidad'
...
if menu == "Ver Inventario": 
    ...
    if not inventario: 
        ...
        # Generación del archivo PDF corregido
