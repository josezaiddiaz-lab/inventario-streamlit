...
# 🎨 CSS PERSONALIZADO PARA OCULTAR HUD Y BARRA LATERAL
st.markdown("""
    <style>
...
# --------INTERFAZ / CABECERA SUPERIOR (Menú a la izquierda, logo al centro, título a la derecha)---------- 
col_menu, col_logo, col_title = st.columns([2.2, 1.2, 2.5])

with col_menu:
    st.write(f"👤 **{st.session_state['usuario']}**")
    
    # Menú desplegable de opciones en la cabecera
    menu = st.selectbox(
        "Opciones", 
