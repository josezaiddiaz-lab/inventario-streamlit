...
def cargar_inventario_dataframe(): 
    try:
        ...
        # Si la hoja está completamente vacía, creamos la estructura base con cabeceras obligatorias
        ...
        # Filtrar filas vacías de forma segura (para no borrar registros válidos)
