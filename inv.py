        ...
        if prod_seleccionado:
            ...
            with col_img:
                ...
                if isinstance(img_url, str) and img_url.strip():
                    ...
                    st.info("Este producto no tiene una imagen asignada.")
                
                # Widget para subir archivo desde la computadora
                archivo_subido = st.file_uploader("Sube una imagen nueva", type=["png", "jpg", "jpeg"])
                
                if archivo_subido is not None:
                    # Opcional: Puedes guardar el archivo localmente o pasarlo a bytes/base64
                    # Nota: Para guardarlo de forma persistente en Google Sheets sin un servidor de archivos, 
                    # muchos usuarios suelen subir la imagen a un bucket (como Cloudinary, ImgBB, S3) 
                    # o guardarla convirtiéndola a texto Base64, aunque la opción de URL externa suele ser la más ligera.[cite: 4]
